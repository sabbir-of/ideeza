...
export default class testData {
        ...
        //Queck Start Section Text Start From Here
        getAddComponentText() {
        ...
        getAddedSuccessfullyText() {
                return "Added Successfully"
        }

        getAddPartsOrComponentsPlaceholderText() {
                return "Add parts or components"
        }

        getAutomatedComponent() {
                return "Automated Component"
        }

        getAutomatedParts() {
                return "Automated Parts"
        }
        getComponentNameTitle() {
                return "Name"
        }
        getComponentDescriptionTitle() {
                return "Description"
        }
        getComponentCatagoryTitle() {
                return "Category"
        }
        getAddPartsOrComponents() {
                return "cover"
        }
        getAddPartsOrComponentsAtmega() {
                return "Atmega"
        }
        getAddPartsOrComponentsSystemDefined() {
                return "System Defined"
        }
        getAddPartsOrComponentsCaps() {
                return "COVER"
        }
        getCreateNewProject() {
                return "CREATE NEW"
        ...
        getProjectName() {
                return "Automation Project Name"
        }
        getProjectLicense() {
                return "MIT License"
        }
        getProjectBlockChainMint() {
                return "Polygon Testnet (Mumbai)"
        }
        getProjectBlockChainMintPolygon() {
                return "Polygon"
        }
